...
public class HardwareControler
{
    ...
    /* com.friendlyarm.AndroidSDK.SPI */
    ...
    //com.friendlyarm.AndroidSDK.GPIOEnum.LOW or com.friendlyarm.AndroidSDK.GPIOEnum.HIGH
    static public native int setGPIOValue(int pin, int value);
    static public native int getGPIOValue(int pin);
    //com.friendlyarm.AndroidSDK.GPIOEnum.IN or com.friendlyarm.AndroidSDK.GPIOEnum.OUT
    ...
    static {
        try {
            ...
            Log.d("com.friendlyarm.AndroidSDK.HardwareControler", "libfriendlyarm-hardware library not found!");
        }
    }
}
